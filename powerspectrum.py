...
def write_spectra(filename, vktot_norm, vkx_norm, vky_norm, vkz_norm, kx,  ky,  kz, Ptot):
    ...
    file.write("Ptot %e\n" % Ptot)
    file.write(
        "  vktot_norm     vkx_norm     vky_norm     vkz_norm           kx           ky           kz\n")
