...
Rho50 = np.mean(np.transpose(Rho50),axis=1)
...
plt.title('AGNRun1884')
#plt.plot(rad,T0)
#plt.plot(rad,T25,label = 't=25')
plt.plot(rad,T50,label = 'T(t) = 50')
plt.plot(rad,Rho50[1],label=r'$/rho (t)$ = 50')
