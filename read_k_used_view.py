...
n, bins, patches = plt.hist(
    kk.kk_vec_x, 5, normed=0, facecolor='red', alpha=0.75)
plt.title("kk_vec_x")

plt.subplot(1, 3, 2)
n, bins, patches = plt.hist(
    kk.kk_vec_y, 5, normed=0, facecolor='green', alpha=0.75)
plt.title("kk_vec_y")

plt.subplot(1, 3, 3)
n, bins, patches = plt.hist(
    kk.kk_vec_z, 5, normed=0, facecolor='blue', alpha=0.75)
plt.title("kk_vec_z")


plt.figure()
n, bins, patches = plt.hist(
    kk.phi, 40, normed=0, facecolor='green', alpha=0.75)
plt.title("phi")
...
plt.subplot(1, 3, 1)
n, bins, patches = plt.hist(
    kk.forcing_kk_part_x, 40, normed=0, facecolor='red', alpha=0.75)
plt.ylim([0, 60])
plt.title("forcing_kk_part_x")

plt.subplot(1, 3, 2)
n, bins, patches = plt.hist(
    kk.forcing_kk_part_y, 50, normed=0, facecolor='green', alpha=0.75)
plt.ylim([0, 60])
plt.title("forcing_kk_part_y")

plt.subplot(1, 3, 3)
n, bins, patches = plt.hist(
    kk.forcing_kk_part_z, 50, normed=0, facecolor='blue', alpha=0.75)
plt.ylim([0, 60])
