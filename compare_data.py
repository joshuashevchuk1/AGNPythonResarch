...
xx1, yy1, zz1, lnrho1, uu_x1, uu_y1, uu_z1, uu_tot1 = rvar.read_whole_grid(
    data_dir=dir1, include_ghost=include_ghost)
xx2, yy2, zz2, lnrho2, uu_x2, uu_y2, uu_z2, uu_tot2 = rvar.read_whole_grid(
    data_dir=dir2, include_ghost=include_ghost)
...
if view == "uu_x":
    acplt.plot_simple(uu_x1, uu_x2, slice_plane, slice_pos,
                      curve_axis, view, xx2, yy2, zz2)
    acplt.plot_once(diff_uu_x, slice_plane, slice_pos, "uu_x2 - uu_x1")

if view == "uu_y":
    acplt.plot_simple(uu_y1, uu_y2, slice_plane, slice_pos,
                      curve_axis, view, xx2, yy2, zz2)
    acplt.plot_once(diff_uu_y, slice_plane, slice_pos, "uu_y2 - uu_y1")

if view == "uu_z":
    acplt.plot_simple(uu_z1, uu_z2, slice_plane, slice_pos,
                      curve_axis, view, xx2, yy2, zz2)
    acplt.plot_once(diff_uu_z, slice_plane, slice_pos, "uu_z2 - uu_z1")

if view == "lnrho":
    acplt.plot_simple(lnrho1, lnrho2, slice_plane, slice_pos,
                      curve_axis, view, xx2, yy2, zz2)
    acplt.plot_once(diff_lnrho, slice_plane, slice_pos, "lnrho2 - lnrho1")

if view == "uu_tot":
    acplt.plot_simple(uu_tot1, uu_tot2, slice_plane,
                      slice_pos, curve_axis, view, xx2, yy2, zz2)
