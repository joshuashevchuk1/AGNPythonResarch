...
def save_as_images(slice_cube, steps, filebase):
    ...
    for sli in range(0, steps):
        ...
        aslice_pix = ((aslice+abs(slice_min)) /
                      (slice_max+abs(slice_min))) * 255.0
...
save_as_images_pylab(animation1, nslice, xx, yy, zz,
                     "animation_images/density_xy_", 'Density', onedim=onedim)
save_as_images_pylab(animation2, nslice, xx, yy, zz,
                     "animation_images/uu_xy_", 'Velocity', onedim=onedim)
save_as_images_pylab(animation3, nslice, xx, yy, zz,
                     "animation_images/velx_xy_", 'Velocity (x)', onedim=onedim)
save_as_images_pylab(animation4, nslice, xx, yy, zz,
                     "animation_images/vely_xy_", 'Velocity (y)', onedim=onedim)
save_as_images_pylab(animation5, nslice, xx, yy, zz,
                     "animation_images/velz_xy_", 'Velocity (z)', onedim=onedim)
...
save_as_images_pylab(animation1, nslice, xx, yy, zz,
                     "animation_images/density_xz_", 'Density', onedim=onedim)
save_as_images_pylab(animation2, nslice, xx, yy, zz,
                     "animation_images/uu_xz_", 'Velocity', onedim=onedim)
save_as_images_pylab(animation3, nslice, xx, yy, zz,
                     "animation_images/velx_xz_", 'Velocity (x)', onedim=onedim)
save_as_images_pylab(animation4, nslice, xx, yy, zz,
                     "animation_images/vely_xz_", 'Velocity (y)', onedim=onedim)
save_as_images_pylab(animation5, nslice, xx, yy, zz,
                     "animation_images/velz_xz_", 'Velocity (z)', onedim=onedim)
...
save_as_images_pylab(animation1, nslice, xx, yy, zz,
                     "animation_images/density_yz_", 'Density', onedim=onedim)
save_as_images_pylab(animation2, nslice, xx, yy, zz,
                     "animation_images/uu_yz_", 'Velocity', onedim=onedim)
save_as_images_pylab(animation3, nslice, xx, yy, zz,
                     "animation_images/velx_yz_", 'Velocity (x)', onedim=onedim)
save_as_images_pylab(animation4, nslice, xx, yy, zz,
                     "animation_images/vely_yz_", 'Velocity (y)', onedim=onedim)
save_as_images_pylab(animation5, nslice, xx, yy, zz,
                     "animation_images/velz_yz_", 'Velocity (z)', onedim=onedim)
